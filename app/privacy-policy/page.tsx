    ...
    return (
        <section className="container mx-auto flex flex-col py-40">
        ...
        <ul>
            ...
            <p>
                ...
                this Agreement) refers to Coach Oye.
            </p>
            </li>
            <li>
            <p>
            ...
            <li>
            <p>
                <strong>Website</strong> refers to Coach Oye, accessible from{' '}
                <a
                href='https://coachme2.fi/'
        ...
        <ul>
            <li>By email: info@coachme2.fi</li>
        </ul>
        </section>
    )
    }
