...
return (
    <div>
    <Header />
    <div className="w-full h-56 bg-cover bg-center" style={{ backgroundImage: `url(${ContactImage2.src})` }}>
        <div className="container mx-auto mb-4">
        </div>
    </div>
    <div className="container mx-auto my-20 px-4">
        <div className="flex flex-col lg:flex-row border-t-2 border-b-2 border-black gap-10">
            <div className="w-full flex flex-col justify-center p-4 lg:border-r-2 border-black">
                <Image
                    src={ContactImage1}
                    alt="Contact Image"
                    width={300}
